...
- [zcash-ika](https://github.com/Frontier-Compute/zcash-ika): Agent custody infrastructure for Zcash. Split-key wallets via 2PC-MPC, on-chain spend policy, privacy attestation. 7 chains. ![GitHub Repo stars](https://img.shields.io/github/stars/Frontier-Compute/zcash-ika?style=social)
