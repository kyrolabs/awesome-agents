...
- [AgentVeil Protocol](https://agentveil.dev): Identity, reputation, and escrow infrastructure for agent economies. W3C DID identity, EigenTrust reputation scores, sybil detection, dispute resolution, and zero-fee escrow payments. Production API, Python SDK (`pip install agentveil`), MCP server.
