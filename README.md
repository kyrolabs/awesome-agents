...
- [SWE-AF](https://github.com/Agent-Field/SWE-AF): Autonomous software engineering fleet built on AgentField. One API call spins up a full engineering team (planner, architect, coder, reviewer, tester) that ships production-grade PRs end-to-end. ![GitHub Repo stars](https://img.shields.io/github/stars/Agent-Field/SWE-AF?style=social)
