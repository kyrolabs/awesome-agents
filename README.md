...
- [context-engine-ai](https://github.com/Quinnod345/context-engine): Lightweight event-based context engine for AI agents. Ingest events, query with natural language, get ranked results with temporal decay and deduplication. Zero config (SQLite + local embeddings). ![GitHub Repo stars](https://img.shields.io/github/stars/Quinnod345/context-engine?style=social)
