...
- [Wee-Orchestrator](https://github.com/leprachuan/Wee-Orchestrator): Self-hosted multi-agent AI orchestrator that coordinates Claude, Gemini, and Copilot CLI from Telegram, WebEx, or browser. 5 runtimes, 17+ models, task scheduling, and extensible skill plugins. ![GitHub Repo stars](https://img.shields.io/github/stars/leprachuan/Wee-Orchestrator?style=social)
