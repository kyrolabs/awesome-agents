...
* [S2-DaoKernel](https://github.com/SpaceSQ/S2-DaoKernel) - An open-source resident safety and alignment framework for autonomous agents. It solves "computational wandering" by grounding AI in physical reality (e.g., Earth, Mars, Metaverse) and Eastern philosophy via memory injection.
