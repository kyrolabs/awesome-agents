...
- [Yume](https://github.com/aofp/yume): Desktop GUI for Claude Code with 4 built-in agents (architect, explorer, implementer, guardian), background agent orchestration, multi-tab sessions, and plugin system.
