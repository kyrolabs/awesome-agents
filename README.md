...
- [Memtrace](https://github.com/syncable-dev/memtrace-public): Memtrace is a persistent memory layer for coding agents, built as a bi‑temporal structural knowledge graph over your codebase (AST‑driven symbols and relationships, plus temporal evolution and cross‑service API topology). ![GitHub Repo stars](https://img.shields.io/github/stars/syncable-dev/memtrace-public?style=social)
