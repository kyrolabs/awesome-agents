...
- [spoox](https://github.com/plaume8/spoox): Terminal-integrated, multi-agent system designed to assist developers directly within their terminal with OS tasks, server management workflows, and software engineering challenges. ![GitHub Repo stars](https://img.shields.io/github/stars/plaume8/spoox?style=social)
