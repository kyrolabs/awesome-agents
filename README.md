...
- [Corellis](https://github.com/CorellisOrg/corellis) - Multi-agent governance framework for OpenClaw with goal decomposition, fleet-wide memory, and correction propagation across agent teams.
