...
- [MHN AI Agent Memory](https://github.com/shahzebqazi/mhn-ai-agent-memory): Associative memory for AI agents using Modern Hopfield Networks. No LLM calls, no database, one matrix multiply. ![GitHub Repo stars](https://img.shields.io/github/stars/shahzebqazi/mhn-ai-agent-memory?style=social)
