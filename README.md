...
- [Bzzz](https://github.com/fengjunhui/bzzz): Declarative orchestration engine for AI Agents — Argo Workflows for AI Agents. 9 patterns (sequence, parallel, conditional, loop, delegate, supervisor, compete, escalation, alongside), SwarmFile YAML protocol, any runtime (local/Docker/HTTP/A2A). Rust. ![GitHub Repo stars](https://img.shields.io/github/stars/fengjunhui/bzzz?style=social)
