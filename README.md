...
- [kodo](https://github.com/ikamensh/kodo): Multi-agent coding orchestrator that improves underlying agent accuracy — adding orchestration around Cursor boosted SWE-bench Verified resolve rate by 24%. ![GitHub Repo stars](https://img.shields.io/github/stars/ikamensh/kodo?style=social)
