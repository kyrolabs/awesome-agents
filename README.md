...
- [Pythia Oracle](https://github.com/pythia-the-oracle/pythia-oracle-mcp): AI-managed Chainlink oracle with 5-agent architecture. Delivers calculated crypto indicators (EMA, RSI, Bollinger, Volatility) on-chain. MCP server + LangChain integration on PyPI. ![GitHub Repo stars](https://img.shields.io/github/stars/pythia-the-oracle/pythia-oracle-mcp?style=social)
