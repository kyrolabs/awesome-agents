...
- [CamoFox Browser](https://github.com/jo-inc/camofox-browser): Stealth headless browser for AI agents — bypass Cloudflare, bot detection, and anti-scraping with a drop-in Puppeteer/Playwright replacement built on a Firefox fork. ![GitHub Repo stars](https://img.shields.io/github/stars/jo-inc/camofox-browser?style=social)
