...
- [Skillfold](https://github.com/byronxlg/skillfold): YAML-based pipeline compiler for multi-agent AI workflows. Compiles a single config into native agent files for 11 platforms (Claude Code, Cursor, Copilot, Gemini, and more) with skill composition, typed state schemas, and execution flows. ![GitHub Repo stars](https://img.shields.io/github/stars/byronxlg/skillfold?style=social)
