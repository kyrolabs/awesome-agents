...
- [AgenticMail](https://github.com/agenticmail/agenticmail): Self-hosted email and SMS platform for AI agents. Each agent gets its own real email address and phone number. Send and receive real email via local Stalwart mail server, SMS via Google Voice, fetch verification codes. MCP server, REST API, OpenClaw plugin, and CLI. MIT licensed. ![GitHub Repo stars](https://img.shields.io/github/stars/agenticmail/agenticmail?style=social)
