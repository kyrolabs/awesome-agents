...
- [Harness Evolver](https://github.com/raphaelchristi/harness-evolver): LangSmith-native autonomous agent optimization. Spawns multi-agent proposers that evolve prompts, routing, tools, and architecture in isolated git worktrees with regression guards. ![GitHub Repo stars](https://img.shields.io/github/stars/raphaelchristi/harness-evolver?style=social)
