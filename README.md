...
- [ORCH](https://github.com/oxgeneral/ORCH): CLI runtime for typed AI agent teams — orchestrates Claude Code, OpenCode, Codex, and Cursor with state machine (todo→review→done), auto-retry, inter-agent messaging, TUI dashboard, and programmatic npm API. ![GitHub Repo stars](https://img.shields.io/github/stars/oxgeneral/ORCH?style=social)
