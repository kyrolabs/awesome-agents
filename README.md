...
- [AgentStamp](https://github.com/vinaybhosle/agentstamp): Trust intelligence for AI agents — identity stamps, reputation scoring (0-100), registry, and A2A passports via x402 micropayments. 14 MCP tools, Ed25519 signatures, SDK for Node.js and Python. ![GitHub Repo stars](https://img.shields.io/github/stars/vinaybhosle/agentstamp?style=social)
