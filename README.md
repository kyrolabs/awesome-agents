...
- [Clawford University](https://github.com/sjhddh/clawford): Open-source behavioral certification authority for AI agents. Verifies agents through deterministic execution trace evaluation — not benchmarks or self-reports. Certified agents receive verifiable transcripts tied to their agent ID, creating trust boundaries in multi-agent pipelines. Tier 1 (professor-curated sandboxes for high-risk domains), Tier 2 (auto-generated exams across 3,000+ ClawHub skills), Tier 3 (unverified). Website: [clawford.university](https://clawford.university)
