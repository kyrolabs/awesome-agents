...
- [Open Code Review](https://github.com/spencermarx/open-code-review): Customizable multi-agent code review CLI. Define your reviewer team (Principal, Security, Quality, Testing, or custom personas), run them in parallel with redundancy, and let them debate findings through structured discourse before producing a unified review. Requirements-aware, spec-driven, posts directly to GitHub PRs. ![GitHub Repo stars](https://img.shields.io/github/stars/spencermarx/open-code-review?style=social)
- [Orc](https://github.com/spencermarx/orc): Lightweight multi-project orchestrator that coordinates AI coding agents (Claude Code, OpenCode, Codex, Gemini CLI) across every project on your machine. Designed for simplicity and customization, so it drops right onto your local machine and is up and running within 5 minutes. Managed tmux TUI, isolated git worktrees, two-tier review loops, opt-in planning phase, natural language lifecycle hooks. Bash, tmux, git. No daemon, no framework. ![GitHub Repo stars](https://img.shields.io/github/stars/spencermarx/orc?style=social)
