...
- [smelt](https://github.com/leonardcser/smelt): Rust-based terminal UI coding agent supporting multiple AI providers (OpenAI, Anthropic, Ollama, GitHub Copilot) with file manipulation, bash execution, session management, and multi-agent capabilities. ![GitHub Repo stars](https://img.shields.io/github/stars/leonardcser/smelt?style=social)
