...
- [Almirant](https://almirant.ai?utm_source=awesome-agents&utm_medium=awesome-list&utm_campaign=march-2026): Operating system for human-agent teams. Persistent context across sessions, shared memory between agents, structured task lifecycle (plan → implement → review → deploy), and human approval gates. ![npm](https://img.shields.io/npm/v/almirant)
