...
- [Conduit](https://github.com/abaveja313/conduit): Conduit is an agent that can organize, edit, and read local files directly from the browser. No installation, downloads, or uploads required.
