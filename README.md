...
- [agenttest](https://github.com/vtx-dev/agenttest): pytest-native testing for AI agent workflows. Record tool calls as traces, replay them offline, assert on sequences and arguments, measure non-determinism. Zero dependencies, works with any agent framework.
