...
- [agenttrace](https://github.com/luoyuctl/agenttrace): TUI observability for AI coding agents. Tracks cost, tokens, tool failures, anomalies, health, and CI gates across Claude Code, Codex CLI, Gemini CLI, Aider, and Cursor exports. ![GitHub Repo stars](https://img.shields.io/github/stars/luoyuctl/agenttrace?style=social)
