...
- [Parallel Code](https://github.com/johannesjo/parallel-code): Desktop app for orchestrating multiple AI coding agents (Claude Code, Codex CLI, Gemini CLI) in parallel, each in isolated git worktrees. ![GitHub Repo stars](https://img.shields.io/github/stars/johannesjo/parallel-code?style=social)
