...
- [SidClaw](https://github.com/sidclawhq/platform): Open-source approval and audit layer for AI agents. Evaluates agent tool calls against policies and holds them for human review before execution. Tamper-proof hash-chain audit trail, identity management, and 13 framework integrations (MCP, LangChain, CrewAI, OpenAI Agents, Vercel AI). Apache 2.0. ![GitHub Repo stars](https://img.shields.io/github/stars/sidclawhq/platform?style=social)
