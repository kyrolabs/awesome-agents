...
- [Parallel Code](https://github.com/nicobailon/parallel-code): Desktop app for orchestrating multiple AI coding agents (Claude Code, Codex CLI, Gemini CLI) in parallel, each in isolated git worktrees. ![GitHub Repo stars](https://img.shields.io/github/stars/nicobailon/parallel-code?style=social)
