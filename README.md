...
- [AgentTrust](https://github.com/vitaliiserbynassisterr/quality-oracle): Pre-payment quality gate for AI agents. Evaluates competency via challenge-response testing with 3-level evaluation (manifest, functional, domain expert), 6-axis scoring, multi-judge consensus, and W3C Verifiable Credentials. ![GitHub Repo stars](https://img.shields.io/github/stars/vitaliiserbynassisterr/quality-oracle?style=social)
