...
- [weco-cli](https://github.com/WecoAI/weco-cli): Terminal agent that optimizes code via autoresearch — it edits a file, runs your eval, and keeps the change only if the metric improves. ![GitHub Repo stars](https://img.shields.io/github/stars/WecoAI/weco-cli?style=social)
