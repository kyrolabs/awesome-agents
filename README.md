...
- [Mnemo](https://github.com/nKOxxx/Mnemo): Long-term memory system for AI agents with project-based data lake architecture, SQLite storage, and encrypted credential vault. ![GitHub Repo stars](https://img.shields.io/github/stars/nKOxxx/Mnemo?style=social)
