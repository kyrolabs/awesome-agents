...
- [Fermi](https://github.com/ekreloff/ai-agent-society): Self-governing AI agent society with constitutional governance, 7 specialized agents, pheromone-based coordination, and self-improving skills. Built on Claude Code. ![GitHub Repo stars](https://img.shields.io/github/stars/ekreloff/ai-agent-society?style=social)
