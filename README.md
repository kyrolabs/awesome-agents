...
- [NERV](https://github.com/juanmanueldaza/nerv): Invisible engineering infrastructure for AI agents on OpenCode. SDD pipeline, A2A hub, MAGI memory, 9 subagents. Scaffolds 45+ files via `nerv init`. ![GitHub Repo stars](https://img.shields.io/github/stars/juanmanueldaza/nerv?style=social)
