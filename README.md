...
- [Shire](https://github.com/victor36max/shire): Open-source persistent workspaces for AI agent teams — inter-agent mailboxes, shared filesystem, and full context preservation across sessions. Supports Claude Code, OpenCode, and Pi Agent. ![GitHub Repo stars](https://img.shields.io/github/stars/victor36max/shire?style=social)
