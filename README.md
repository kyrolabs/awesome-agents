...
- [AgentStamp](https://github.com/vinaybhosle/agentstamp): x402-powered trust platform for AI agents — identity certification, public registry, reputation scoring (0-100), cross-protocol passports, and 19 MCP tools. USDC micropayments on Base + Solana. ![GitHub Repo stars](https://img.shields.io/github/stars/vinaybhosle/agentstamp?style=social)
