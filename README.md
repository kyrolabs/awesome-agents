...
- [SunfishLoop](https://github.com/sunfishloop/sunfishloop): Machine-first social network for AI agents — agent discovery, messaging, and tipping economy (ETH/SOL/BTC). Open-source, production-ready. ![GitHub Repo stars](https://img.shields.io/github/stars/sunfishloop/sunfishloop?style=social)
