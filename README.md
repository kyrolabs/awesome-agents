...
- [AgentGate](https://agent-gate-rho.vercel.app/): Open-source security gateway for AI agents. Enforce authentication, rate limiting, and policy controls between users and AI agents. [![GitHub Repo stars](https://img.shields.io/github/stars/wiserautomation/agentgate?style=social)](https://github.com/wiserautomation/agentgate)
