...
- [AdaL](https://github.com/SylphAI-Inc/adal): AI coding CLI from SylphAI with multi-model support (Claude, GPT, Gemini) and powerful file editing tools. ![GitHub Repo stars](https://img.shields.io/github/stars/SylphAI-Inc/adal?style=social)
