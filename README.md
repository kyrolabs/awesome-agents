...
- [AgentPlane](https://github.com/basilisk-labs/agentplane): Git-native workflow control plane for AI coding agents. Keeps task intent, approved plans, verification evidence, finish state, and Agent Change Records in-repo for Claude Code, Codex, Cursor, and Aider workflows. ![GitHub Repo stars](https://img.shields.io/github/stars/basilisk-labs/agentplane?style=social)
