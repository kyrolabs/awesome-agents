...
- [Plot Ark](https://github.com/Schlaflied/Plot-Ark): Self-hosted agentic curriculum engine for higher education — generates pedagogically grounded course content using LightRAG knowledge graph, xAPI learning analytics pipeline, and multi-provider LLM support. ![GitHub Repo stars](https://img.shields.io/github/stars/Schlaflied/Plot-Ark?style=social)
