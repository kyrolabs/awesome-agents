...
- [k8s4claw](https://github.com/Prismer-AI/k8s4claw): Kubernetes operator for managing heterogeneous AI agent runtimes. One CRD for lifecycle, IPC bus, channel sidecars (Slack/Discord), auto-updates, and persistence. ![GitHub Repo stars](https://img.shields.io/github/stars/Prismer-AI/k8s4claw?style=social)
