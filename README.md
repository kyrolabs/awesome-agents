...
- [Agents Shipgate](https://github.com/ThreeMoonsLab/agents-shipgate): Static release-readiness gate for AI agent tool surfaces. Scans local MCP exports, OpenAPI specs, OpenAI Agents SDK files, Anthropic Messages API artifacts, Google ADK, LangChain/LangGraph, and CrewAI without running agents or calling tools. ![GitHub Repo stars](https://img.shields.io/github/stars/ThreeMoonsLab/agents-shipgate?style=social)
