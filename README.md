...
- [Anuki](https://github.com/cylonmolting-creator/anuki): Open-source multi-agent AI platform with soul-driven identity, cognitive memory, and response-level claim verification. Create agents via natural language. Node.js. ![GitHub Repo stars](https://img.shields.io/github/stars/cylonmolting-creator/anuki?style=social)
