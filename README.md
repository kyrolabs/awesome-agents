...
- [Shellgate](https://github.com/matthiastjong/shellgate): Open-source TypeScript security gateway for AI agents — scoped API tokens, credential injection, human-in-the-loop approval workflows, SSH execution via MCP, vault for secure credential storage, wiki, memories, org skills, webhook ingestion, and audit logging. Self-hosted (Docker) or managed cloud. ![GitHub Repo stars](https://img.shields.io/github/stars/matthiastjong/shellgate?style=social)
