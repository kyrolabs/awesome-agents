...
- [HOL Standards Agent Kit](https://github.com/hashgraph-online/standards-agent-kit): AI Agent Kit for Hashgraph Online SDK. Provides tools for building autonomous agents with blockchain-based identity (ERC-8004, UAIDs), discovery via Universal Agentic Registry, and decentralized commerce capabilities. ![GitHub Repo stars](https://img.shields.io/github/stars/hashgraph-online/standards-agent-kit?style=social)
