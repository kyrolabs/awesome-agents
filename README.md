...
- [context-engine-ai](https://github.com/Quinnod345/context-engine): Real-time context engine for AI agents. Ingest events from any source, query with natural language, get ranked results with temporal decay and deduplication. Zero-config default (SQLite + local TF-IDF embeddings). ![GitHub Repo stars](https://img.shields.io/github/stars/Quinnod345/context-engine?style=social)
