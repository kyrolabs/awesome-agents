...
- [ShaprAI](https://github.com/Scottcjn/shaprai): Agent lifecycle management platform for onboarding, retiring, and orchestrating AI agents with RTC gas payments via Beacon relay. ![GitHub Repo stars](https://img.shields.io/github/stars/Scottcjn/shaprai?style=social)
- [Beacon Skill](https://github.com/Scottcjn/beacon-skill): Agent discovery and P2P messaging skill with registration, heartbeat, and relay networking for autonomous agent communication. ![GitHub Repo stars](https://img.shields.io/github/stars/Scottcjn/beacon-skill?style=social)
