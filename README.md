...
- [ATXP](https://github.com/atxp-dev/atxp): Agent identity and payment infrastructure. One CLI command gives an AI agent a USDC wallet on Base, `@atxp.email` inbox, phone number, and 100+ paid tools (web search, image/video gen, LLM gateway, SMS). No KYC, no human login, $5 free credit. ![GitHub Repo stars](https://img.shields.io/github/stars/atxp-dev/atxp?style=social)
