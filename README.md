...
- [agenttrace](https://github.com/luoyuctl/agenttrace): TUI observability for AI coding agent sessions. Tracks tokens, cost, latency, tool failures, anomalies, health scores, diffs, and CI health gates across Claude Code, Codex CLI, Gemini CLI, Aider, Cursor exports, and more. ![GitHub Repo stars](https://img.shields.io/github/stars/luoyuctl/agenttrace?style=social)
