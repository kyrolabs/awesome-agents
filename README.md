...
- [EmblemAI](https://github.com/EmblemCompany/EmblemAi-AgentWallet): Open-source AI agent wallet SDK for crypto operations. 200+ tools covering swaps, conditional orders, DeFi, NFTs, and cross-chain bridges across Solana, Ethereum, Base, BSC, Polygon, Hedera, and Bitcoin. Integrates via npm CLI or A2A protocol. x402 payment rails. ![GitHub Repo stars](https://img.shields.io/github/stars/EmblemCompany/EmblemAi-AgentWallet?style=social)
