...
- [Hermit](https://github.com/orca-ai-admin/hermit): Self-evolving agent framework — behavioral enforcement via shell scripts instead of system prompt rules. 11 Red Gates, memory consolidation, self-improvement engine. Markdown + shell scripts, no SDK, model-agnostic. ![GitHub Repo stars](https://img.shields.io/github/stars/orca-ai-admin/hermit?style=social)
