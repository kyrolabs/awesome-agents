...
- [great_cto](https://github.com/avelikiy/great_cto): Claude Code plugin running a full SDLC pipeline with 7 specialized agents (tech-lead, senior-dev, qa-engineer, security-officer, devops, l3-support, project-auditor). 12-angle code review, 10 project archetypes, 13 compliance frameworks, two-gate approval flow. You make 2 decisions per feature, the rest is automated. ![GitHub Repo stars](https://img.shields.io/github/stars/avelikiy/great_cto?style=social)
