...
- [SideButton](https://github.com/sidebutton/sidebutton): Open-source MCP server with 40+ browser automation tools, a YAML workflow engine, Chrome extension, and installable knowledge packs that teach AI agents the selectors, data models, and workflows of specific web apps. ![GitHub Repo stars](https://img.shields.io/github/stars/sidebutton/sidebutton?style=social)
