...
- [iriseye](https://github.com/iriseye931-ai/iriseye): Local AI mesh — Claude Code + Hermes + OpenClaw agents sharing persistent memory via OpenViking. Includes MCP servers, Apple Silicon MLX setup, auto-start plists, pf firewall rules, and a real-time [mission control dashboard](https://github.com/iriseye931-ai/mission-control-dashboard). Fully self-hosted. ![GitHub Repo stars](https://img.shields.io/github/stars/iriseye931-ai/iriseye?style=social)
