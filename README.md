...
- [boss-agent-cli](https://github.com/can4hou6joeng4/boss-agent-cli): AI-agent-first CLI and MCP server for BOSS Zhipin job search and recruiter workflows, with structured JSON output, interview-prep generation, and automation hooks for Claude Code, Codex, Cursor, and Windsurf. ![GitHub Repo stars](https://img.shields.io/github/stars/can4hou6joeng4/boss-agent-cli?style=social)
