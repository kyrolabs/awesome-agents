...
- [AI Models Catalog](https://github.com/i-need-token/ai-models): Structured database of 4,587+ AI models across 95 providers with pricing, context windows, and capabilities. Essential for choosing the right model for your agent — filter by tool calling, reasoning, structured output, and more. ![GitHub Repo stars](https://img.shields.io/github/stars/i-need-token/ai-models?style=social)
