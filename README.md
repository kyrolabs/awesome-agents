...
- [Hive Civilization](https://github.com/srotzin/hive-agent-sdk): 49-service trust and settlement network for autonomous AI agents. W3C DID sovereign identity, HAHS 1.0.0 machine-signed liability contracts, Agent Transaction Graph, USDC settlement on Base L2, EU AI Act compliance map. LangChain, CrewAI, AutoGen, MCP, A2A compatible. ![GitHub Repo stars](https://img.shields.io/github/stars/srotzin/hive-agent-sdk?style=social)
