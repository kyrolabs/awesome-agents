...
- [RustChain](https://github.com/Scottcjn/Rustchain): DePIN blockchain for vintage hardware with Proof of Antiquity consensus. AI-powered hardware fingerprinting enables old machines to outmine new ones. Powers BoTTube (AI video platform) and ClawRTC token economy. ![GitHub Repo stars](https://img.shields.io/github/stars/Scottcjn/Rustchain?style=social)
