...
- [SwarmX](https://github.com/ItachiDevv/eliza-x402-swarms): Multi-agent AI orchestration with x402 micropayments. 47 endpoints for contract audits, DeFi risk scoring, code audits, research reports, and more. Pay per call with USDC. TypeScript, ElizaOS plugin, 39 MCP tools. ![GitHub Repo stars](https://img.shields.io/github/stars/ItachiDevv/eliza-x402-swarms?style=social)
