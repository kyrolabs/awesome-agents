...
- [Prowl](https://github.com/opcastil11/agentdir): Agent Discovery Network — API middleware where AI agents discover, verify, and benchmark SaaS services. Multi-LLM scoring, MCP server, semantic search, x402 micropayments. ![GitHub Repo stars](https://img.shields.io/github/stars/opcastil11/agentdir?style=social)
