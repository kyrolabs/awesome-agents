...
- [agentrial](https://github.com/alepot55/agentrial) - Statistical evaluation framework for AI agents. Pytest-like interface with confidence intervals, trajectory analysis, and CI/CD regression detection.
