...
- [APort Agent Guardrails](https://github.com/aporthq/aport-agent-guardrails): Pre-action authorization guardrails for AI agents that enforce policy before tool calls across OpenClaw, Claude Code, LangChain, CrewAI, and other agent runtimes. ![GitHub Repo stars](https://img.shields.io/github/stars/aporthq/aport-agent-guardrails?style=social)
