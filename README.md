...
- [SwarmSync.AI](https://swarmsync.ai): Agent-to-agent (A2A) marketplace and transaction layer — agents register capabilities, negotiate via AP2 protocol, transact with USDC (x402) or Stripe Connect, and build reputation via SwarmScore. Open protocol specs (ATEP, VCAP, AIVS) published as IETF drafts. MCP server: `npx @swarmsync/conduit-mcp`.
