...
- [REDMYTHOS CLAW](https://github.com/pentrestion/redmythos-claw): Autonomous AI agent framework optimized for Termux on Android. Features dynamic tool loading, persistent task tracking, and structured reasoning. ![GitHub Repo stars](https://img.shields.io/github/stars/pentrestion/redmythos-claw?style=social)
