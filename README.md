...
- [agent-security-harness](https://github.com/msaleme/red-team-blue-team-agent-fabric): Pre-deployment adversarial security test framework for autonomous agents. 470+ executable tests across MCP, A2A, x402, L402 wire protocols. NIST AI 800-2 aligned. ![GitHub Repo stars](https://img.shields.io/github/stars/msaleme/red-team-blue-team-agent-fabric?style=social)
