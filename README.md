...
- [Permission Protocol](https://github.com/permission-protocol/deploy-gate): Cryptographic approval gates for AI agent actions. Blocks deploys, data access, and tool calls until a named human signer approves. Ed25519-signed receipts, fail-closed enforcement, <200ms latency. GitHub Action + SDK. ![GitHub Repo stars](https://img.shields.io/github/stars/permission-protocol/deploy-gate?style=social)
