...
- - [FIVE Character Engine](https://github.com/kiro0x/five-character-engine): LLM character consistency engine that returns JSON personality/style constraints via a single API endpoint. Keeps character voices stable across sessions. Paid API with MCP integration.
