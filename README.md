...
- [Alfred](https://github.com/luminik-io/alfred-os): Self-hosted runtime for autonomous Claude Code and Codex agents that turn GitHub issues into pull requests. Worktree isolation, label-driven state, role-based engine routing, and Slack reports. Python, MIT. ![GitHub Repo stars](https://img.shields.io/github/stars/luminik-io/alfred-os?style=social)
