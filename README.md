...
- [Notte](https://notte.cc/) - Browser infrastructure for AI agents. Managed sessions, built-in agent runtime, and auth primitives for production web automation at scale. [![GitHub Repo stars](https://img.shields.io/github/stars/nottelabs/notte?style=social)](https://github.com/nottelabs/notte)
