...
- [Kitaru](https://github.com/zenml-io/kitaru): Durable execution layer for AI agents. Checkpoints, replay, resume, wait, and memory primitives that make agent workflows persistent and replayable — no graph DSL required. ![GitHub Repo stars](https://img.shields.io/github/stars/zenml-io/kitaru?style=social)
...
- [ChatAgentRelay](https://github.com/ChatAgentRelay/ChatAgentRelay): Relay infrastructure for connecting multiple chat platforms (Slack, Teams, Discord, Telegram, WhatsApp, Lark, DingTalk, any more) to any A2A-compatible agent with multi-agent routing, policy governance, immutable audit trail, and reliable message delivery. ![GitHub Repo stars](https://img.shields.io/github/stars/ChatAgentRelay/ChatAgentRelay?style=social)
