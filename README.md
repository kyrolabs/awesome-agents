...
- [Familiar](https://github.com/bedda-tech/familiar): Open-source AI agent orchestration platform powered by Claude Code with persistent task queue, web dashboard, Telegram bot, and webhooks. Self-hostable. ![GitHub Repo stars](https://img.shields.io/github/stars/bedda-tech/familiar?style=social)
