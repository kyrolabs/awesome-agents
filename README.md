...
- [CrewClaw](https://crewclaw.com): Form-based no-code AI agent generator for the OpenClaw framework. Pick a role from 242+ templates, configure tools and channels, download a complete deploy package (Dockerfile, docker-compose, bot file, AGENTS.md). One-time $9-$29 pricing, 205-template open-source library at [awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents). ![GitHub Repo stars](https://img.shields.io/github/stars/mergisi/awesome-openclaw-agents?style=social)
