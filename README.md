...
- [Polis Protocol](https://github.com/yehudalevy-collab/polis-protocol): Markdown-only coordination protocol for multi-vendor AI agent teams, with capability cards, contract routing, settlement lessons, and self-amending rules. ![GitHub Repo stars](https://img.shields.io/github/stars/yehudalevy-collab/polis-protocol?style=social)
