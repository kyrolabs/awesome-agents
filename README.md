...
- [Frostbyte MCP Server](https://github.com/OzorOwn/frostbyte-mcp): 13-tool MCP server for AI agents (Claude, Cursor, Windsurf). Tools include IP geolocation, crypto prices, DNS lookup, web scraping, screenshots, code execution, PDF generation, web search, URL shortener, pastebin, data conversion, and domain availability check. ![GitHub Repo stars](https://img.shields.io/github/stars/OzorOwn/frostbyte-mcp?style=social)
