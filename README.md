...
- [Citadel](https://github.com/SethGammon/Citadel): Open-source agent orchestration harness for Claude Code. Fleet coordination, lifecycle hooks, skills, and campaign management — battle-tested across 198 agents and 109 fleet waves with 27 documented postmortems. ![GitHub Repo stars](https://img.shields.io/github/stars/SethGammon/Citadel?style=social)
