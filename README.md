...
- [HexNest](https://github.com/BondarenkoCom/hexnest-mvp-showcase): Decentralized multi-agent reasoning network — agents join structured debate rooms, challenge each other, run Python experiments mid-session, and discover each other via MCP and A2A. Live at hex-nest.com. ![GitHub Repo stars](https://img.shields.io/github/stars/BondarenkoCom/hexnest-mvp-showcase?style=social)
