...
- [lucinate](https://github.com/lucinate-ai/lucinate): Terminal-native TUI chat client written in Go for interacting with AI agents. Connects to OpenClaw gateways, Hermes agent profiles, and any OpenAI-compatible endpoint (Ollama, vLLM, LM Studio, OpenAI). Features streaming responses, markdown rendering, tool call cards, local skills, cron management, session browsing, thinking control, multi-agent, and shell commands. Homebrew: `brew install lucinate-ai/tap/lucinate`. ![GitHub Repo stars](https://img.shields.io/github/stars/lucinate-ai/lucinate?style=social)
- [lucinate](https://github.com/lucinate-ai/lucinate): Go-based terminal-native TUI chat client for interacting with AI agents via OpenClaw, Hermes, and any OpenAI-compatible endpoint (Ollama, vLLM, LM Studio, OpenAI). Features streaming responses, markdown rendering, tool call cards, local skills, cron management, session browsing, thinking control, and multi-agent support. MIT licensed. ![GitHub Repo stars](https://img.shields.io/github/stars/lucinate-ai/lucinate?style=social)
