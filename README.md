...
- [Skillfold](https://github.com/byronxlg/skillfold): Configuration language and compiler for multi-agent AI pipelines, compiling a single YAML config into native agent files for 11 platforms. ![GitHub Repo stars](https://img.shields.io/github/stars/byronxlg/skillfold?style=social)
