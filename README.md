...
- [Autonomous Agents](https://github.com/KeepALifeUS/autonomous-agents): Production multi-agent orchestration using stigmergy pattern. 4 specialized agents coordinate through shared environment achieving 80% token reduction. Built with Claude API and TypeScript. ![GitHub Repo stars](https://img.shields.io/github/stars/KeepALifeUS/autonomous-agents?style=social)
