...
- [Hashgraph Online (HOL)](https://github.com/hashgraph-online): Universal registry and trust engine for AI agents — bridges A2A, MCP, Virtuals, ERC-8004, x402, OpenConvAI, and NANDA protocols with official SDKs in TypeScript, Go, and Python ![GitHub Repo stars](https://img.shields.io/github/stars/hashgraph-online/hol?style=social)
