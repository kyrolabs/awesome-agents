...
- [Cortex](https://github.com/agentweave/cortex): Open protocol for coordinating AI agent teams through plain markdown files. Chief-of-staff pattern — one coordinator manages workers. Ships as a Claude Code plugin. Runtime-agnostic (Claude Code, Codex, Cursor, Gemini CLI, OpenCode). ![GitHub Repo stars](https://img.shields.io/github/stars/agentweave/cortex?style=social)
