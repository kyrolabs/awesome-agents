...
- [FCoP](https://github.com/joinwell52-AI/FCoP): File-based Coordination Protocol — behavior governance layer for multi-agent teams. Filename-as-protocol, folders-as-message-bus, 35 MCP tools. Registered on official MCP Registry. MIT. ![GitHub Repo stars](https://img.shields.io/github/stars/joinwell52-AI/FCoP?style=social)
