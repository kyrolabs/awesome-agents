...
- [Orkas](https://github.com/Orkas-AI/Orkas): Open-source multi-agent AI desktop client — a commander LLM dispatches sub-agents in parallel or series with visibility slicing, and agents self-evolve via reflection to crystallize successful approaches into private skill libraries. Local-first across macOS/Windows/Linux with BYO LLM keys (Claude, OpenAI, Gemini, DeepSeek, Kimi, GLM, Qwen). ![GitHub Repo stars](https://img.shields.io/github/stars/Orkas-AI/Orkas?style=social)
