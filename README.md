...
- [The Polyglot Protocol](https://github.com/sabir-gbs/the-polyglot-protocol): Senior-engineer protocol for AI coding agents with repository discovery, 22-language guidance, validation workflows, and post-codegen audit scoring. Supports Codex, Claude Code, OpenCode, and similar agents. ![GitHub Repo stars](https://img.shields.io/github/stars/sabir-gbs/the-polyglot-protocol?style=social)
