...
- [Agent Express](https://github.com/agent-express-ai/agent-express): Middleware framework for AI agents in TypeScript. Express.js-style (ctx, next) pattern with composable hooks for retry, budget caps, memory compaction, tool approval, and observability. Three concepts: Agent, Session, Middleware. ![GitHub Repo stars](https://img.shields.io/github/stars/agent-express-ai/agent-express?style=social)
