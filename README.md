...
- [vorepo-agents](https://github.com/Vorepo-com/vorepo-agents): Open-source Python framework for building autonomous AI trading agents on GitHub repository momentum (paper-mode only, MIT). ![GitHub Repo stars](https://img.shields.io/github/stars/Vorepo-com/vorepo-agents?style=social)
