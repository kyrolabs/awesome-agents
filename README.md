...
- [CoWorker Protocol](https://github.com/ZiwayZhao/agent-coworker): P2P agent collaboration over XMTP with schema-based skill invocation, E2E encryption, and revocable trust. Zero dependencies. ![GitHub Repo stars](https://img.shields.io/github/stars/ZiwayZhao/agent-coworker?style=social)
