...
- [MartinLoop](https://github.com/Keesan12/martin-loop): Open-source control plane for AI coding agents with hard budget caps, verify gates, and JSONL run records. ![GitHub Repo stars](https://img.shields.io/github/stars/Keesan12/martin-loop?style=social)
