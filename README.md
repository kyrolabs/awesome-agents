...
- [Octopal](https://github.com/pmbstyle/Octopal): Secure local multi-agent runtime with isolated workers, policy-controlled tool execution, recurring tasks, and a private dashboard for autonomous software work. ![GitHub Repo stars](https://img.shields.io/github/stars/pmbstyle/Octopal?style=social)
