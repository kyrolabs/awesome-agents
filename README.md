...
- [Kazi Core](https://github.com/bedah-kym/kazi-core): Self-hostable agent engine on Django with built-in connectors (WhatsApp, Gmail, Calendly, M-Pesa via IntaSend, Amadeus travel), 3-tier memory, durable workflows on Temporal, double-entry ledger, action receipts with risk gates, and per-room AES-256-GCM encryption. Container is cosign-signed (keyless via Sigstore) and ships SBOM + provenance. ![GitHub Repo stars](https://img.shields.io/github/stars/bedah-kym/kazi-core?style=social)
