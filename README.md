...
- [Bridge ACE](https://github.com/Luanace-lab/bridge-ide): Local multi-agent platform. 5 AI engines (Claude, Codex, Qwen, Gemini, Grok) coordinating in real-time via WebSocket. 204 MCP tools. Soul Engine for persistent identity. Apache 2.0. ![GitHub Repo stars](https://img.shields.io/github/stars/Luanace-lab/bridge-ide?style=social)
