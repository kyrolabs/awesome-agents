...
- [Computer Agents SDK](https://github.com/computer-agents/computer-agents-sdk-python): Official Python SDK for [Computer Agents](https://computer-agents.com). Build and control persistent, scheduled AI agents running in isolated cloud environments with persistent memory, file system, and 24/7 execution. ![GitHub Repo stars](https://img.shields.io/github/stars/computer-agents/computer-agents-sdk-python?style=social)
