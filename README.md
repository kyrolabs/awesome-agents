...
- [Playwright-Praman](https://github.com/mrkanitkar/playwright-praman): Agent-first SAP UI5 test automation plugin for Playwright. AI agents (Claude Code, Copilot, Cursor) plan, generate, and self-heal E2E tests for SAP S/4HANA and Fiori apps using the UI5 runtime registry — no DOM selectors. ![GitHub Repo stars](https://img.shields.io/github/stars/mrkanitkar/playwright-praman?style=social)
