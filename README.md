...
- [WebOperator](https://github.com/KazKozDev/WebOperator): A Chrome extension browser agent — pure agent loop (observe → decide → act → verify). One tool call at a time, plan enforcement, runs locally on Ollama. TypeScript, MIT. ![GitHub Repo stars](https://img.shields.io/github/stars/KazKozDev/WebOperator?style=social)
