...
- [musecl-memory](https://github.com/musecl/musecl-memory): Zero-dependency file-based memory sync for AI agents using bash, git, and markdown. No databases or API keys needed. ![GitHub Repo stars](https://img.shields.io/github/stars/musecl/musecl-memory?style=social)
