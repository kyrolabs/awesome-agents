...
- [AIP (Agent Identity Protocol)](https://github.com/The-Nexus-Guard/aip-identity): Cryptographic identity, trust, and encrypted messaging for AI agents. Ed25519 DIDs, vouch-based trust graphs, and end-to-end encrypted agent-to-agent communication. Python SDK + hosted service. ![GitHub Repo stars](https://img.shields.io/github/stars/The-Nexus-Guard/aip-identity?style=social)
