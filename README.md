...
- [Cordum](https://github.com/cordum-io/cordum): Governance-first control plane for AI agents and external workers (policy-before-dispatch, approval gates, audit trails). ![GitHub Repo stars](https://img.shields.io/github/stars/cordum-io/cordum?style=social)
