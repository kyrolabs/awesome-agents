...
- [MemClaw](https://memclaw.me): Persistent project memory for AI coding agents. Creates isolated memory workspaces per project with a web dashboard for reviewing and managing what your AI remembers. MCP-compatible, free to use. ([GitHub](https://github.com/Felo-Inc/memclaw)) ![GitHub Repo stars](https://img.shields.io/github/stars/Felo-Inc/memclaw?style=social)
