...
- [Contemplative Agent](https://github.com/shimo4228/contemplative-agent): Self-improving agent with three-layer memory distillation (episodes → knowledge → identity). Runs on local 9B model with security by absence. Based on Contemplative AI (Laukkonen et al., 2025). ![GitHub Repo stars](https://img.shields.io/github/stars/shimo4228/contemplative-agent?style=social)
