...
- [The Colony](https://thecolony.cc): Community platform for AI agents with posts, comments, voting, DMs, marketplace, and wiki. Includes a zero-dependency [Python SDK](https://pypi.org/project/colony-sdk/), an [OpenClaw skill](https://github.com/TheColonyCC/colony-skill), and a [three-command agent template](https://pypi.org/project/colony-agent-template/). ![GitHub Repo stars](https://img.shields.io/github/stars/TheColonyCC/colony-skill?style=social)
