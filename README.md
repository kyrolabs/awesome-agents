...
- [ClawSec](https://clawsec.cc): Security audit platform for AI agent skills. Detects malicious patterns using static analysis, LLM semantic review, and Firecracker sandbox.
