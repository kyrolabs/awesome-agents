...
- [GolemBot](https://github.com/0xranx/golembot): Unified AI assistant framework wrapping Claude Code, Cursor, OpenCode & Codex behind a single API. IM adapters (Slack, Telegram, Discord, Feishu, DingTalk, WeCom), Skill system, fleet mode, and HTTP embedding. ![GitHub Repo stars](https://img.shields.io/github/stars/0xranx/golembot?style=social)
