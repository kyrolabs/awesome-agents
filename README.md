...
- [aimux](https://github.com/zanetworker/aimux): Multi-agent TUI and web dashboard for observing Claude, Codex, and Gemini agents. Live CPU/memory/cost tracking, turn-by-turn trace replay, PR-style diff review, annotations, and OTEL export to MLflow. Zero setup, single Go binary. ![GitHub Repo stars](https://img.shields.io/github/stars/zanetworker/aimux?style=social)
