...
- [ag2ag](https://github.com/Maretto/ag2ag): Operational layer for running A2A-compatible agents on a single host. Node.js + systemd. Local registry, lifecycle management, CLI. ![GitHub Repo stars](https://img.shields.io/github/stars/Maretto/ag2ag?style=social)
