...
- [Stoneforge](https://github.com/stoneforge-ai/stoneforge): Open-source orchestration for AI coding agents. Run multiple agents in parallel with automatic dispatch, merge, and recovery. ![GitHub Repo stars](https://img.shields.io/github/stars/stoneforge-ai/stoneforge?style=social)
